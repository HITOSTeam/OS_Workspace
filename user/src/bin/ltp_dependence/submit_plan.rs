...
const RISCV_LTP_GROUPS: &[LtpGroup] = &[
    ...
    // &super::UNRUN_NET_STRESS_INTERFACE_V4_TASKS,
    // &super::UNRUN_NET_STRESS_ROUTE_TASKS,
    // &super::UNRUN_NET_IPSEC_TCP_SMOKE_TASKS,
    // &super::UNRUN_NET_IPSEC_UDP_ICMP_SMOKE_TASKS,
    // &super::UNRUN_NET_CMDS_TASKS,
    // &super::UNRUN_NET_MULTICAST_TASKS,
    // &super::UNRUN_NET_STRESS_MULTICAST_TASKS,
